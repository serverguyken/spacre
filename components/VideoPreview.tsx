        ...
        <div className="video_preview_container relative">
            {
                loading
                    ...
                    : <div className='video_preview_main relative mt-5'>
                        <div className='video_preview_image'>
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <Video id="video_preview_video" isAd={false} src={video}  />
                        </div>
                        <div className='video_preview_close absolute bg-dimGray top-4 left-4 cursor-pointer absolute  min-w-[28px] min-h-[28px]  z-[24] flex justify-center items-center rounded-full' onClick={onClose}>
                            <Tooltip
                                title="Close
                    "
                                placement="center"
