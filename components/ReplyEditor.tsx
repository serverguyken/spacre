...
const ReplyEditor = ({ spaceUser, user, onReply }: {
    spaceUser: User,
    user: User,
    onReply: (reply: Reply, cbs: {
        onSuccess: () => void,
        onError: (err: any) => void
    }) => void,
}) => {
    const { addSpace, hasError, error } = useUserContext()
