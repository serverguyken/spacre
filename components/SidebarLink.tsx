        ...
        <Link href={fullpath}>
            <a className={setClass(`${text}_sidebar_link_item`,"main_sidebar_links flex justify-start space-x-3")}>
                <div className="relative">
                    ...
                    <div className={setClass(`${text}_sidebar_tooltip`,"main_sidebar_tooltip invisible opacity-0 absolute top-14 z-[50] bg-gray-500 dark:bg-darkModeBg dark:text-white p-1 text-center text-xs text-white rounded shadow-sm", text === "Messages" ? 'w-[4.5rem]' : 'w-[3.5rem]', text === "Messages" ? '-left-5' : '-left-3')}>
